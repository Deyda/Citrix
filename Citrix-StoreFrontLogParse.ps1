...
& '.\Citrix-StoreFrontLogParse.ps1' -computers storefront01,storefront02 -last 10h
...
& '.\Citrix-StoreFrontLogParse.ps1' -computers storefront01,storefront02 -sinceBoot -subtypes error -outputFile storefront.errors.csv
