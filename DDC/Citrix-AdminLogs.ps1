...
& '.\Citrix-AdminLogs.ps1' -username manuel -gridview -last 14d -operation "Shadow"

Show all shadow operations performed by the user manuel in the last 14 days and display in a grid view

.EXAMPLE

& '.\Citrix-AdminLogs.ps1' -start "01/01/2018" -end "31/01/2018" -configChange -outputfile c:\temp\citrix.changes.csv
