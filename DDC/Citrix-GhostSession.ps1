...
& '.\Citrix-GhostSession.ps1' -ddc ctxddc001 -hide -mailserver smtp001 -recipients guy.leech@mars.com,sarah.kennedy@venus.com -historyfile c:\scripts\ghosties.csv
...
& '.\Citrix-GhostSession.ps1' -ddc ctxddc001 
