...
& '.\Citrix-DailyCheck.ps1' -ddcs ctxddc01 -pvss -ctxpvs01 -mailserver smtpserver -proxymailserver msscom01 -qualifier "Constoso" -recipients support@somehwere.com,bob@contoso.com
