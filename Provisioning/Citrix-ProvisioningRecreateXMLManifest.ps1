...
& '.\Citrix-ProvisioningRecreateXMLManifest.ps1' -sqlserver GRL-SQL01\Instance2 -database CitrixProvisioning -diskPath S:\Store\xaserver2016.vhdx -production
...
& '.\Citrix-ProvisioningRecreateXMLManifest.ps1' -diskPath S:\Store\xaserver2016.vhdx
