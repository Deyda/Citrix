...
& '.\Citrix-ProvisioningTargetBootTime.ps1' -last 7d -output c:\boot.times.csv
...
& '.\Citrix-ProvisioningTargetBootTime.ps1' -last 90d -chartview -computers pvsserver1,pvsserver2

Will show PVS boot times in a chart in the last 90 days for the PVS servers pvsserver1 and pvsserver2

.EXAMPLE

& '.\Citrix-ProvisioningTargetBootTime.ps1' -last 7d -output c:\boot.times.csv -mailserver mailserver -recipients someone@somewhere.com -meanAbove 180 -computers pvsserver1,pvsserver2
